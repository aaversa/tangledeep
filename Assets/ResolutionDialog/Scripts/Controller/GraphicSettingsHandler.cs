...
namespace NewResolutionDialog.Scripts.Controller
{
    public class GraphicSettingsHandler : MonoBehaviour
    {
        ...
        const int EXCLUSIVE_FULLSCREEN = 0;
        const int FULLSCREEN_WINDOWED = 1;
        ...
        void PopulateDropdowns()
        {
            ...
            if (isChinese)
            {
                fullScreenMode.options[0].text = "全屏显示";
                fullScreenMode.options[1].text = "窗口（全屏）";
                fullScreenMode.options[2].text = "窗口";
            }
        ...
        void PopulateMonitorDropdown()
        {
            ...
            string displayWord = "Display ";

            if (isChinese) displayWord = "显示";
            ...
            for (int i = 0; i < Display.displays.Length; i++)
            {
                ...
                var displayString = displayWord + (i + 1) + " (" + GetResolutionString(display.systemWidth, display.systemHeight) + ")";
        ...
        */
        ...
        public void OnMonitorChanged()
        {
            ...
            if (displayNote != null && displayNote.gameObject != null) 
            {
                displayNote.gameObject.SetActive(false);
            }
